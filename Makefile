...
INCLUDES2 := -I/usr/opt/cuda/7.0/include
LIBRARIES :=
...
ifneq ($(HIGHEST_SM),)
GENCODE_FLAGS += -maxrregcount=63 -gencode arch=compute_$(HIGHEST_SM),code=compute_$(HIGHEST_SM)# -keep --ptxas-options=-v -maxrregcount=63
endif
endif
...
HEADER =  struct.h mpi_info.h gpu_info.h test.h init_config.h  device_function.cuh mesh.h mesh_mpi.h smc.h io.h init.h
...
main.o:main.cpp $(HEADER)
	$(EXEC) $(MPICXX) $(INCLUDES2)$(MPI_CCFLAGS) -o $@ -c $<

mpi_info.o:mpi_info.cpp $(HEADER)
	$(EXEC) $(MPICXX) $(INCLUDES2) $(MPI_CCFLAGS) -o $@ -c $<

test.o:test.cpp $(HEADER)
	$(EXEC) $(MPICXX) $(INCLUDES) $(INCLUDES2) $(MPI_CCFLAGS) -o $@ -c $<

mesh_mpi.o:mesh_mpi.cpp $(HEADER)
	$(EXEC) $(MPICXX) $(INCLUDES) $(INCLUDES2) $(MPI_CCFLAGS) -o $@ -c $<

gpu_info.o:gpu_info.cu $(HEADER)
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

init_config.o:init_config.cu $(HEADER)
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

device_function.o:device_function.cu $(HEADER)
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

mesh.o:mesh.cu $(HEADER)
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
...
scmf: main.o mpi_info.o gpu_info.o init_config.o test.o  device_function.o mesh.o mesh_mpi.o init.o smc.o io.o
